...
#celeba_data_dir = "C:/Users/sutte/OneDrive/Desktop/Développement logiciel/img_align_celeba_short"
...
class VAE(nn.Module):
    ...
    def reparameterize(self, mu, log_var, variance_scale=5.0):
        # Multiplier log_var par une valeur supérieure à 1 pour augmenter la variance
